...
use Hoop\Contacts\Api\ContactRepositoryInterface;
use Hoop\Contacts\Api\Data\ContactInterface;
use Hoop\Contacts\Model\ContactFactory;
...
class ContactRepository implements \Hoop\Contacts\Api\ContactRepositoryInterface
{
